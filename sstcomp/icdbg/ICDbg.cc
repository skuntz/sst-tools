...
ICDebug::tokenize(std::vector<std::string>& tokens, const std::string& input)
{
...
void
ICDebug::cmd_help(std::vector<std::string>& UNUSED(tokens))
{
...
void
ICDebug::cmd_pwd(std::vector<std::string>& UNUSED(tokens))
{
...
void
ICDebug::cmd_cd(std::vector<std::string>& tokens)
{
    if ( tokens.size() != 2 ) {
...
void
ICDebug::cmd_print(std::vector<std::string>& tokens)
{
...
void
ICDebug::cmd_set(std::vector<std::string>& tokens)
{
    if ( tokens.size() != 3 ) {
...
void
ICDebug::cmd_time(std::vector<std::string>& UNUSED(tokens))
{
    printf("current time = %" PRI_SIMTIME "\n", getCurrentSimCycle());
}

void
ICDebug::cmd_run(std::vector<std::string>& tokens)
{
    if ( tokens.size() == 2 ) {
        try {
...
void
ICDebug::dispatch_cmd(std::string cmd)
{
